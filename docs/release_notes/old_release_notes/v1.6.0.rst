...
- New :class:`~graphinglib.SmartFigure`, :class:`~graphinglib.SmartFigureWCS` and :class:`~graphinglib.SmartTwinAxis` that unify the :class:`~graphinglib.Figure` and :class:`~graphinglib.MultiFigure` classes

- New :class:`LegendElement` objects to create custom legend entries
...
(`pr-662 <https://github.com/GraphingLib/GraphingLib/pull/662>`_)
...
(`pr-666 <https://github.com/GraphingLib/GraphingLib/pull/666>`_)
...
(`pr-652 <https://github.com/GraphingLib/GraphingLib/pull/652>`_)
...
* `#652 <https://github.com/GraphingLib/GraphingLib/pull/652>`_ : Fixed "default" params not replaced in `Shapes`' `_plot_element` method

* `#662 <https://github.com/GraphingLib/GraphingLib/pull/662>`_ : split axis colors in set_visual_params

* `#666 <https://github.com/GraphingLib/GraphingLib/pull/666>`_ : Converted "default" to Inherit type and marker
